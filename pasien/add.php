...
<body>
    <div class="row header">
        <div class="col-12">
            ...
            <h1 class="brand">TAMBAH DATA PASIEN</h1>
        </div>
    </div>
            ...
            <div class="col-lg-8 col-lg-offset-2">
                <form action="proses.php" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_rm" id="no_rm" class="form-control" required autofocus>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="ttl" id="ttl" class="form-control" required></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="save">
                        ...
                        <button type="submit" name="add" data-toggle="tooltip" data-placement="right" title="Klik untuk menambahkan data pasien"><i class="bi bi-save-fill"></i></button>
                    </div>
                </form>
