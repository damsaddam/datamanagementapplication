...
<body>
    <div class="row header">
        <div class="col-12">
            ...
            <h1 class="brand">TAMBAH DATA DOKTER</h1>
        </div>
    </div>
            ...
            <div class="col-lg-8 col-lg-offset-2">
                <form action="proses.php" method="post">
                    ...
                    <div class="save">
                        ...
                        <button type="submit" name="add" data-toggle="tooltip" data-placement="right" title="Klik untuk menambahkan data dokter"><i class="bi bi-save-fill"></i></button>
                    </div>
                </form>
