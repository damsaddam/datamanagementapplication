...
<head>
    ...
    <title>IMPORT DATA DOKTER</title>
    <style>
        body {
            background: #000428;
...
<body>
    <div class="row header">
        <div class="col-12">
            ...
            <h1 class="brand">IMPORT DATA DOKTER</h1>
        </div>
    </div>
    <div class="row content">
        <div class="col-12">
            <div class="regulator">
                <button class="download" data-toggle="tooltip" data-placement="top" title="Download template file excel data dokter"><a href="../assets/file/template/DATA DOKTER KLINIK PRIMA UTAMA MEDIKA.xlsx"><i class="bi bi-file-earmark-arrow-down-fill"></i></a></button>
                <button class="back" data-toggle="tooltip" data-placement="top" title="Klik untuk kembali ke data dokter"><a href="data.php"><i class="bi bi-arrow-90deg-left"></i></a></button>
            </div>
