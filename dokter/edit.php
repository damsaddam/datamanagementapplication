...
<body>
    <div class="row header">
        <div class="col-12">
            ...
            <h1 class="brand">EDIT DATA DOKTER</h1>
        </div>
    </div>
    <div class="row content">
        <div class="back">
            <button data-toggle="tooltip" data-placement="left" title="Klik untuk kembali ke data dokter"><a href="data.php"><i class="bi bi-arrow-90deg-left"></i></a></button>
        </div>
        <div class="col-lg-8 col-lg-offset-2">
            <?php
            $id = @$_GET['id'];
            $sql_dokter = mysqli_query($connect, "SELECT * FROM dokter WHERE id_dokter = '$id'") or die(mysqli_error($connect));
            ...
            <form action="proses.php" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="sip" id="sip" value="<?= $data['sip'] ?>" class="form-control" required autofocus>
                </div>
                <div class="form-group">
                    <label for="nama_dokter">Nama Dokter</label>
                    <input type="text" name="nama_dokter" id="nama_dokter" value="<?= $data['nama_dokter'] ?>" class="form-control" required>
                </div>
                <div class="form-group">
                ...
                <div class="save">
                    ...
                    <button type="submit" name="edit" data-toggle="tooltip" data-placement="right" title="Klik untuk edit data dokter"><i class="bi bi-save-fill"></i></button>
                </div>
            </form>
