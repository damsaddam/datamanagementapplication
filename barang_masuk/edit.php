...
<body>
    <div class="row header">
        <div class="col-12">
            ...
            <h1 class="brand">EDIT DATA BARANG MASUK</h1>
        </div>
    </div>
    <div class="row content">
        ...
        <div class="col-lg-8 col-lg-offset-2">
            <?php
            $id = @$_GET['id'];
            $sql_barangmasuk = mysqli_query($connect, "SELECT * FROM barang_masuk WHERE id_barang = '$id'") or die(mysqli_error($connect));
            $data = mysqli_fetch_array($sql_barangmasuk);
            ?>
            <form action="proses.php" method="post">
                <div class="form-group">
                    <label for="tgl_masuk">Tgl. Masuk</label>
                    <input type="hidden" name="id" value="<?= $data['id_barang'] ?>">
                    <input type="date" name="tgl_masuk" id="tgl_masuk" value="<?= $data['tgl_masuk'] ?>" class="form-control" required autofocus>
                </div>
                <div class="form-group">
