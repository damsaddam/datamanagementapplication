...
<body>
    <div class="row header">
        <div class="col-12">
            ...
            <h1 class="brand">DATA BARANG MASUK</h1>
        </div>
    </div>
                ...
                <table class="table table-bordered" id="myTable">
                    ...
                    <tbody>
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == "POST") {
                            ...
                            if ($pencarian != '') {
                                $sql = "SELECT * FROM barang_masuk ORDER BY tgl_masuk ASC, id_barang ASC";
                                $query = $sql;
                                $queryJml = $sql;
                            } else {
                                $query = "SELECT * FROM barang_masuk ORDER BY tgl_masuk ASC, id_barang ASC LIMIT $posisi, $batas";
                                $queryJml = "SELECT * FROM barang_masuk ORDER BY tgl_masuk ASC, id_barang ASC";
                                $no = $posisi + 1;
                            }
                        } else {
                            $query = "SELECT * FROM barang_masuk ORDER BY tgl_masuk ASC, id_barang ASC LIMIT $posisi, $batas";
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#myTable').DataTable({
                ...
                buttons: [{
                        extend: 'pdf',
                        title: 'DATA BARANG MASUK GUDANG PT. AMSKY INDONESIA',
                        download: 'open',
