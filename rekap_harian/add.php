...
<head>
    ...
    <title>TAMBAH DATA REKAP BULANAN</title>
    <style>
        body {
            background: #000428;
...
<body>
    <div class="row header">
        <div class="col-12">
            ...
            <h1 class="brand">TAMBAH DATA REKAP BULANAN</h1>
        </div>
    </div>
            ...
            <div class="col-lg-8 col-lg-offset-2">
                <form action="proses.php" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="bulan" id="bulan" class="form-control" required autofocus>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="keluar" id="keluar" class="form-control" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="laba" id="laba" class="form-control" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="paraf" id="paraf" class="form-control">
                    </div>
                    <div class="save">
